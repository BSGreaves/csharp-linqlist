        ...
        static void Main(string[] args)
        {
           // Find the words in the collection that start with the letter "L"
            ...
            var alphebetized = 
                ...
                orderby name
                select name;
            // foreach (string name in alphebetized)
            // {
            ...
            */
            ...
            /* 
                ...
                CITI 1
            */
            // var millionaires = customers.Where(cust => cust.Balance >= 1000000)
...
// Queue<string> poptartFlavors = new Queue<string>();
// poptartFlavors.Append("Banana");
// poptartFlavors.Append("Strawberry");
// poptartFlavors.Append("Blueberry");

// IEnumerable <string> bTarts = from flavor in poptartFlavors
// where flavor.StartsWith("B")
// select flavor;
// forEach (var f in bTarts)
// {
//     Console.WriteLine(f);
// }


// var grouped = mill in millionaires
...
// var grouped = mill in millionaires
//     group mill by mill.Bank into taco
//     select new { Bank = taco.Key, Customer = taco}
